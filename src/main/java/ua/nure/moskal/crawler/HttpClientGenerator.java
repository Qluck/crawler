...
public class HttpClientGenerator {
    ...
    private SSLConnectionSocketFactory buildSSLConnectionSocketFactory() {
        try {
            return new SSLConnectionSocketFactory(createIgnoreVerifySSL(), new String[]{"SSLv2Hello","SSLv3", "TLSv1", "TLSv1.1", "TLSv1.2"},
                    null,
                    new DefaultHostnameVerifier()); // prioritize bypassing the security certificate
    ...
    private SSLContext createIgnoreVerifySSL() throws NoSuchAlgorithmException, KeyManagementException {
        ...
        SSLContext sc = SSLContext.getInstance("TLS");//Change SSLv3 to TLS, mainly to modify this place
